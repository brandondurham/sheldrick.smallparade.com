...
const Content = [
  {
    anchor: 'about',
    content: `<p>My name is Brandon Durham. I’ve been a <em>Software Engineer</em> and <em>Designer</em> professionally for more than 18 years. My primary focus has always been front-end development with a strong interest in its relationship to design — particularly typography. I’m a developer first, a designer second, and love the intersection of the two.</p>
...
<p>When I think about the organizations I would most love to dedicate my time and capabilities to—organizations that would allow me to do what I love while supporting a product I believe in—<em>${ORG}</em> is an undeniable contendor.</p>
<p>When Covid hit I began ordering puzzles obsessively. I noticed that almost across the board the quality was very, very poor, regardless of what the manufacturer promised or charged. I started to actively seek out companies that treated their products with more respect. I found <em>Le Puzz</em> pretty quickly and connected immediately with the style and humor. When my first of many orders arrived it was clear that yours is one of the very few companies that truly delivers on your promise.</p>
<p>I have a job. By nearly all measures you could say it’s good one. But at the end of the day I’m really just helping someone make money when more than anything I want to be proud of the work I do and the product it supports.</p>
...
<p>You might be wondering <a href="#work">what kind of work I’ve done in the past</a>, or <a href="#what">what I might be able to do for you</a>. If so, read on!</p>`,
  ...
  {
    anchor: 'work',
    content: `<p>Here are just a few examples of my work on the web. More examples and greater detail around the duties performed here can be supplied by <a href="#contact">request</a>.</p>
<ol class="work">
  <li>
  ...
  <li>
    <a href="https://typography.com/" target="_blank"><strong>Hoefler&amp;Co.</strong></a> In 2012 I threw caution to the wind and applied for a position with my design heroes of many years, Hoefler&amp;Co (né Hoefler &amp; Frere-Jones). I spent eight of the best professional years of my life working on wildly progressive and creative projects and launched some of the best work I’ve ever been a part of, the biggest being the redesign of <a href="https://typography.com/" target="_blank">the company site</a>. Other notable projects included a custom browser-based type-testing tool called <a href="https://try.typography.com/" target="_blank">Try.typography</a>; a graphic-design-heavy type showcase called <a href="https://discover.typography.com/" target="_blank">Discover.typography</a>; and one of the world’s biggest subscription services for boutique webfonts, <a href="https://www.typography.com/webfonts" target="_blank">Cloud.typography</a> (now part of Monotype).
  </li>
  <li>
    <a href="https://www.baltimorebrew.com/" target="_blank"><strong>Baltimore Brew.</strong></a> Created in partnership with <a href="https://www.posttypography.com/" target="_blank">Post Typography</a> who designed the site, I built a full <small><abbr title="Content Management System">CMS</abbr></small> with an <small><abbr title="Application Programming Interface">API</abbr></small> layer for the front-end to communicate with via a <small><abbr title="Representational State Transfer">REST</abbr>ful</small> interface. The <small>CMS</small> included several custom user permissions levels managed by the <small><abbr title="Chief Executive Officer">CEO</abbr></small>, allowing reporters to manage their content and only their content. I also handled all front-end development, which included ensuring the site was fully-responsive and rendered correctly and efficiently on any device.
  </li>
  <li>
    <a href="https://besthorrorscenes.com/" target="_blank"><strong>Best Horror Scenes.</strong></a> One of my first loves in life was for Horror films and television. This project is my ongoing love letter of the genre and its better entries (subjectively speaking, of course). I handled all design as well as front- and back-end development.
  </li>
  <li>
  ...
  {
    anchor: 'what',
    content: `<p>I’ve handled many different roles over the years. While with <em>Fringe</em> (2020–2023) I acted primarily as <em>Lead Engineer</em> managing a small team of developers, but also took on an interim role as <em>Design Director</em> and managed a team of three. With <em>Hoefler&amp;Co</em> (2012–2020) I acted as a <em>Full-stack Developer</em>, a <em>Designer</em>, and managed several other developers during this time. I also designed and developed a proprietary <abbr title="Customer Relationship Manager"><small>CRM</small></abbr> that is still in use to this day. While working with <em>Adlucent</em> (2008–2012) I acted as the sole <em>Senior Front-end Developer</em>; <em>Lead Designer</em>; and managed all of my own projects. I tackled a wide array of projects there, including redesigning and developing the company site; designing t-shirts and conference materials; and building many landing pages for clients that included Multivariate and A/B tests.</p>
...
<p>If desired I can share Jonathan’s contact information for a referral along with a few other colleagues, managers, agencies, and clients I’ve worked with.</p>`,
  ...
  {
    anchor: 'contact',
    content: `<p>I would love the opportunity to talk with <em>${ORG}</em>. I’m currently located in the US Pacific time zone (<a href="https://maps.google.com?q=2745%20Borrego%20Springs%20Rd,%20Borrego%20Springs,%20CA%2092004&ftid=0x0:0xd5ba3ba3ff953fe9&hl=en-US&gl=us&entry=gps&lucs=,47071704,47069508,47084304,94202299&g_st=ic">Borrego Springs, CA</a>) but I’m happy to accommodate any time zone in the event you would like to have a phone or Zoom call.</p>
<ul>
